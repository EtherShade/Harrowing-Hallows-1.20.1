package net.ethershade.harrowinghallows.worldgen.portal;

import net.ethershade.harrowinghallows.block.ModBlocks;
import net.ethershade.harrowinghallows.block.custom.ModPortalBlock;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.HALLOWED_PORTAL.get().defaultBlockState(), 3);
            }
        }
