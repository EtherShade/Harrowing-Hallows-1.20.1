...
public class ModBiomes {
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HALLOWED_PLACED_KEY);
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .fogColor(0x000000)
                        .waterColor( 0x00234d)
                        .waterFogColor(0x102c50)
                        .skyColor(0x000000)
                        .grassColorOverride(0xa6621b)
