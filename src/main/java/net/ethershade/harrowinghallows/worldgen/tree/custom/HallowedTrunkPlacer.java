...
public class HallowedTrunkPlacer extends TrunkPlacer {
    public static final Codec<HallowedTrunkPlacer> CODEC = RecordCodecBuilder.create(pineTrunkPlacerInstance ->
            trunkPlacerParts(pineTrunkPlacerInstance).apply(pineTrunkPlacerInstance, HallowedTrunkPlacer::new));

    public HallowedTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
