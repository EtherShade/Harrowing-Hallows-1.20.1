...
public enum ModArmorMaterials implements ArmorMaterial {
    STYXITE("styxite", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, () -> Ingredient.of(ModItems.STYXITE_INGOT.get()));
    ...
    public String getName() {
        return HarrowingHallows.MOD_ID + ":" + this.name;
    }
