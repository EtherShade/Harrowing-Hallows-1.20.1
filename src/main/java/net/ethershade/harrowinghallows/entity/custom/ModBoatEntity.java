package net.ethershade.harrowinghallows.entity.custom;
...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case HALLOWED -> ModItems.HALLOWED_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.HALLOWED.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        HALLOWED(ModBlocks.HALLOWED_PLANKS.get(), "pine");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, HALLOWED);
        }
    }
}
